...
class CustomCache
{
    ...
    {
        return self::getRepo()->get($key, $default);
    }
    ...
    {
        return self::getRepo()->set($key, $value, $ttl);
    }
    ...
    {
        return self::getRepo()->delete($key);
    }
    ...
    {
        return self::getRepo()->getMultiple($keys, $default);
    }
    ...
    {
        return self::getRepo()->setMultiple($values, $ttl);
    }
    ...
    {
        return self::getRepo()->deleteMultiple($keys);
    }
